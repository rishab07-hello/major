...
import { currentIdofCompany } from "../../components/student_placed_details/studen_placed"
...
const PlacementStudentPlaced = () => {  
      const [companyStudentData, setCompanyStudentData] = useState([]);
      const[loading,setloading]=useState(true);
      const option={
        method:'GET',
        url:"http://localhost:9000/api/auth/liststudentPlaced",
...
export default PlacementStudentPlaced;
